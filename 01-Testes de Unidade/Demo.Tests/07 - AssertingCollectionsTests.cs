...
namespace Demo.Tests
{
    public class AssertingCollectionsTests
    {
        ...
        {
            // Arrange & Act
            var funcionario = FuncionarioFactory.Criar("Pedro", 10000);
        ...
        {
            // Arrange & Act
            var funcionario = FuncionarioFactory.Criar("Pedro", 1000);
        ...
        {
            // Arrange & Act
            var funcionario = FuncionarioFactory.Criar("Pedro", 15000);
